...
public void createGUI(){
  ...
  stopwatchBtn = new GButton(this, 360, 160, 80, 28);
  ...
  addTaskButton = new GButton(this, 570, 285, 20, 20);
  ...
  clearButton = new GButton(this, 175, 275, 45, 40); 
  ...
  studyBreakInput = new GTextField(window1, 175, 150, 50, 30, G4P.SCROLLBARS_NONE);
  studyBreakInput.setText("30");
  studyBreakInput.setOpaque(true);
  studyBreakInput.addEventHandler(this, "studyBreakInput_change");
  studyBreakLabel = new GLabel(window1, 125, 70, 150, 100);
  studyBreakLabel.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  studyBreakLabel.setText("Study Break Interval (Minutes)");
  studyBreakLabel.setOpaque(false);
  studyBreakBtn = new GButton(window1, 165, 200, 70, 30);
