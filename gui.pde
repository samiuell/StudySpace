...
public void createGUI(){
  ...
  studyBreakInput = new GTextField(window1, 300, 150, 50, 30, G4P.SCROLLBARS_NONE);
  studyBreakInput.setText("30");
  studyBreakInput.setOpaque(true);
  studyBreakInput.addEventHandler(this, "studyBreakInput_change");
  studyBreakLabel = new GLabel(window1, 250, 70, 150, 100);
  ...
  studyBreakBtn = new GButton(window1, 290, 200, 70, 30);
